...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Lista Usuarios</a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Nuevo registro</a>
  </li>
</ul>
    ...
    <td>ciudad</td>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="txtFecha" name="txtFecha" aria-describedby="emailHelp">
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\miescuela\resources\views/welcome.blade.php ENDPATH**/ ?>